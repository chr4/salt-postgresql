...
control 'psql' do
  ...
  sql = postgres_session('user_without_password', '', '', nil, '/run/postgresql')
  ...
  sql = postgres_session('postgres', '', '', nil, '/run/postgresql')
  ...
  sql = postgres_session('read_only_user', '', '', nil, '/run/postgresql')
